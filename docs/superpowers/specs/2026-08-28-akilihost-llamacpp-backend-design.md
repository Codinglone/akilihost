...
SSH tunnel (port 22, existing key, Host model-tunnel)
   ▼
your-gpu-server VM (T4, your-region)
...
- `az disk update --resource-group YOUR_RESOURCE_GROUP --name <os-disk> --size-gb 256`
...
```
Host model-tunnel
    HostName your-gpu-server.your-region.cloudapp.azure.com
    User your-user
    IdentityFile /home/codinglone/Documents/DU/devops/keys/your-gpu-server_key.pem
    IdentitiesOnly yes
